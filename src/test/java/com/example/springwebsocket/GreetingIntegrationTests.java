...
@ContextConfiguration(classes = {SpringWebsocketApplication.class})
public class GreetingIntegrationTests {
    ...
    public void getGreeting() throws Exception {
        ...
        this.stompClient.connectAsync("ws://localhost:{port}/spring-websocket", this.headers, handler, this.port);
